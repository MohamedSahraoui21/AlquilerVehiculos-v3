	...
	private static final String TITULO="Alquiler Vehiculos";
	...
	private void confirmarSalida(Stage escenario, WindowEvent e) {
		if(Dialogos.mostrarDialogoConfirmacion("Salir","Estas seguro de que quieres de la aplicacion",escenario)) {
			escenario.close();
		}
	else {
		e.consume();
